				...
				<div class="graphs">
					<div class="sign-in-form">
						<div class="sign-in-form-top">
							<p><span>Sign In to</span> <a href="<?php echo base_url(); ?>/application/views/Guru/index.html">Admin</a></p>
						</div>
						<div class="signin">
							...
							<form action="<?php echo base_url(); ?>index.php/Guru/loginProcess" method="post">
							<div class="log-input">
